import 'package:prescribed/multipleprescribtion.dart';
//import 'package:doctordashboard/prescribinginterface.dart';
import 'package:prescribed/profile_settings.dart';
import 'package:prescribed/services.dart';
//import 'package:prescribed/utlis/Notes.dart';
//import 'package:prescribed/utlis/notes.dart';
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, index) {
        return Card(
          elevation: 10.0,
          child: ListTile(
            // title: Text('prescribtion for Patient $index'),
            title: Text('prescribtion for Patient Anand Deshmukh'),
            ...
            trailing: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Multipleprescribtion(index)));
                }),
            onTap: () {
              Navigator.push(
                  context,
